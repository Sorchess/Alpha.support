...
class S3ClientFactory:
    ...
    async def head_object(self, client: AioBaseClient, key: str):
        try:
    ...
    async def get_object(self, client: AioBaseClient, key: str):
        try:
            return await client.get_object(Bucket=self.bucket_name, Key=key)
        except client.exceptions.NoSuchKey:
            raise FileNotFoundException
        except ClientError as ex:
            raise ex
